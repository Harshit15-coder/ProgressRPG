# Progress RPG Documentation

Welcome to the documentation for **Progress RPG**, a productivity role-playing game that combines real-world task management with RPG-inspired systems.

This documentation covers the project's architecture, development processes, operations, and design notes.

## Documentation

* **[Architecture](architecture/index.md)** — Technical structure, systems, and key decisions.
