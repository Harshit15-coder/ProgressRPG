...
interface PlayerSocketListenerProps {
  onEvent?: (data: IncomingWebSocketMessage) => void;
}

export default function PlayerSocketListener({ onEvent }: PlayerSocketListenerProps) {
  ...
  useEffect(() => {
    ...
    const connectSocket = async () => {
      try {
        ...
        console.error('[WS] Connection failed:', (err as Error).message);
      }
    };
