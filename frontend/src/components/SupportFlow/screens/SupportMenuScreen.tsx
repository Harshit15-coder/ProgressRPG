// SupportFlow/screens/SupportMenuScreen.tsx
import React from "react";
import Button from "../../Button/Button";
import styles from "../SupportFlowModal.module.scss";

interface SupportMenuScreenProps {
  onReady?: () => void;
  onNotReady?: () => void;
}

export default function SupportMenuScreen({ onReady, onNotReady }: SupportMenuScreenProps) {
  return (
